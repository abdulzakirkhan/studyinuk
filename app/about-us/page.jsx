            ...
            <div className="container py-4">
                <div className="row py-5 mt-3 mt-md-5">
                    ...
                    <div className="w-80 m-auto">
                        ...
                        <p className="text-white text-center">Our mission is to guide and empower students worldwide who dream of pursuing higher education in the United Kingdom. We’re here to make the journey to studying in the UK as seamless and informed as possible, helping you make well-informed decisions that will shape your future.</p>
                    </div>
                    </div>
                </div>
            </div>
