          ...
          <div className="row py-md-5 mt-3 mt-md-5">
            <div className="col-md-12">
              <div className="w-80 m-auto">
                ...
                <p className="text-white text-center">Welcome to your guide to UK universities!</p>
              </div>
            </div>
      ...
      <div className="container py-4">
        <div className="row justify-content-center">
          <div className="d-flex justify-content-between align-items-center">
            ...
            <button className="btn bgBrown text-white">Apply Filters</button>
          </div>
              ...
              {universities.map((univer) => (
                <div key={univer.id} className={`accordion-item py-2 border-0 bg-transparent ${style.bgTransparent}`}>
                  <h2 className="accordion-header" id={`heading${univer.id}`}>
                    <button
                      type="button"
                      className={`accordion-button ${style.accorBtn}`}
